...
public class Stack {
    ...
    /**
     * Precondition: None
     * Postcondition: Adds a new object on top of the stack
     * 
     * @param object
     */
     ...
     * Postcondition: Top object returned and removed
     *
     * @return object
     */
    public Object pop() {
    ...
    /**
     * Precondition: None 
     * Postcondition: Return the number of items in the stack
     *
     * @return integer
     */
    public int size() {
    ...
    /**
     * Precondition: None 
     * Postcondition: Returns String form of Stack with each object separated by
     * a space
     *
     * @return String
     */
    ...
    /**
     * Precondition: Two Stacks objects exist to be compared 
     * Postcondition: Returns true if the Queues are equal 
     *
     * @param otherStack
     * @return
     */
