...
public class Kernel
{
	...
	case INTERRUPT_SOFTWARE: // System calls
		...
		//instantiate a TCB for current thread
		TCB currentThread;
		return OK;
	    case EXEC:
		...
		currentThread = scheduler.getMyTcb();
		return waitQueue.enqueueAndSleep(currentThread.getTid());
	    case EXIT:
        ...
        currentThread = scheduler.getMyTcb();
        waitQueue.dequeueAndWakeup(currentThread.getPid(), currentThread.getTid());
